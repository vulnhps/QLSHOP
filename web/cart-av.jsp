                        ...
                        <table class="shop-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td >                     
                                        <a href="Giohan?command=plus&product_id=<%=list.getValue().getProduct().getProduct_id()%>&cartID=System.currentTimeMillis()"><img src="images/them.gif" alt=""></a>
                                        <input type="text" style="width: 50px" value="<%=list.getValue().getQuantity()%>">
                                        <a href="Giohan?command=trusp&product_id=<%=list.getValue().getProduct().getProduct_id()%>&cartID=System.currentTimeMillis()"><img src="images/tru.gif" alt=""></a>
                                    </td>
                                    <td>
                                        <h5>
                                            <strong class="red">
                                    ...
                                    <td>
                                        <a href="controllerCa?command=remove&product_id=<%=list.getValue().getProduct().getProduct_id()%>">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="6">
                                        <button class="pull-left" onclick="location.href = 'welcome.jsp'">
                                            Quay về trang chủ
                                        </button>
