...
<%
            ...
            if (request.getParameter("product_id") != null) {
                ...
                qq = productDAO.getProduct(Long.parseLong(productID));
            }
%>
<!DOCTYPE html>
<html>
                ...
                <div class="products-description">
                  ...
                  <div class="wided">
                    ...
                    <div class="button_group">
                      <button class="button" >
                          <a href="controllerCa?command=plus&product_id=<%=qq.getProduct_id()%>">
                              Thêm vào giỏ hàng</a>
                      </button>                     
                  ...
                  <li>
                    <div class="row">
                      ...
                      <div class="col-md-4 col-sm-4">
                        <div class="products">                          
                          <div class="thumbnail">
                              <a href="single-av.jsp?product_id=<%=product.getProduct_id()%>">
                          ...
                          <div class="button_group">
                            <button class="button add-cart" type="button">
                                <a href="controllerCa?command=plus&product_id=<%=product.getProduct_id()%>">
                                    Thêm vào giỏ hàng</a>
                            </button>
