 ...
 * @author HoaiVu
 */
@WebServlet(name = "Giohan", urlPatterns = {"/Giohan"})
public class Giohan extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch (command) {
                ...
                case "trusp":
                    if (cart.getCartItems().containsKey(proid)) {
                        ...
                        cart.subSP(proid, new Item(pro, 1));
                    }
                    break;
                case "remove":
            ...
            e.printStackTrace();
            response.sendRedirect("/SOF301_ASM_vulnhps05401/cart-av.jsp");
        }
